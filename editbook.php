...

{
  ...
  {  
	...
	else
	{
      ...
      $sql="UPDATE `book` SET". "`booksname` ='$bookname',"."`authorname` = '$authorname',"."`genre` = '$genre',"."`file_name` = '$new_file_name',"."`path` = '$fpath'". " WHERE `book`.`b_id` ="."'$id'";
...
<nav> 
  ...
  <div class="nav-links">
    <ul>
      <li><a href="adlibrary.php">Library</a></li>
